...
No decorrer da jornada acadêmica acumulamos não só bons amigos e um punhado de papéis 
(certificados e diplomas), mas acima de tudo conhecimento e experiência que estarão conosco 
independente do que aconteça. 

Este trabalho tem por finalidade descrever minhas atividades acadêmicas e profissionais, 
como fins de concurso para ingresso no corpo docente do Instituto Metrópole Digital.  
As atividades estão organizadas em tópicos, representando as fases da minha vida acadêmica 
e profissional, baseadas nos aspectos pessoais subjacentes.
...
inicialmente no trabalho do meu pai e em seguida em casa. Apesar de não usa-lo para programar
tive sempre curiosidade em melhorar ele como podia, adaptando softwares para funcionar em 
condições não ideias dadoa  limitação de hardware do meu dispositivo. Sempre fui fã de ficção cientifica
e gostava de ler sobre as ultimas novidades tecnologicas na biblioteca, a escola assinava as
revistas Galileu e Superinteressante que sempre traziam informações relevantes. 
...
instalando e configurando emuladores apra diversas plataformas em meu computador.
...
fazer alguns projetos pequenos por conta própria e lendo sobre a área.
...
profissionais durante a graduação e apos o mestrado. O capitulo~\ref{cap_pesquisa} apresenta minha pesquisa 
atual e as razoes de voltar a academia com o doutorado. O capitulo~\ref{cap_ensino} apresenta
...
\begin{summarybox}[frametitle=\faInfoCircle{}\quad Resumo da Formação acadêmica na UFF]
  \begin{datelist}
    ...
    2011--2013 & Mestrado em Ciencia da Computação -- Universidade Federal Fluminense \\
  \end{datelist}
\end{summarybox}
